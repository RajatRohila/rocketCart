...
@Component({
  selector: 'app-upload-courier-details',
  templateUrl: './upload-courier-details.component.html',
  styleUrls: ['./upload-courier-details.component.css']
})
export class UploadCourierDetailsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    formData.append('uploadId', 'uploadCourierDetails');
  ...
  async downloadTemplate() {
    ...
    const fileName = 'uploadCourierDetails';
  ...
  async getProgress() {
        this.apiserviceService.SpinnerService.show();
        const url = AppUrls.UPLOAD_PREOGRESS + '?key=uploadCourierDetails&token=' + this.token;
